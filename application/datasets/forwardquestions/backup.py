...
class ForwardQuestionsTest:

    def __init__(self,data_file="data/all_questions.json",limit=10,kb="wikidata",use_entities=False,get_evidence=False):
        self.limit = limit
        self.data_file=data_file
        self.endpoint="muheqa/"+kb+"/en"
